...
export default function AdminPanel() {
  ...
  const handleDeleteUser = async (userId) => {
    ...
    try {
      ...
      alert('Failed to delete user. You may need the service role key.')
    }
  }
                      ...
                      <tr key={user.id} className="hover:bg-purple-50 transition-colors" style={{ animationDelay: `${index * 0.05}s` }}>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <select
                            ...
                            className="px-4 py-2 border border-gray-300 rounded-lg text-sm font-medium focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all"
                          >
                            <option value="user">👤 User</option>
                            <option value="admin">👑 Admin</option>
                          </select>
              ...
              <div className="flex items-center justify-between p-4">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="px-3 py-2 border border-gray-300 rounded-md text-sm disabled:opacity-50 bg-white"
                  >
                    Prev
                  </button>
                  <button
