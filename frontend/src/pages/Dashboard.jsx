    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 animate-fade-in">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {loading ? (
          ...
          <div className="text-center py-20 glass-effect rounded-xl animate-slide-up">
          ...
          <div className="grid gap-4 animate-slide-up">
            {tasks.map((task, index) => (
              <div 
                key={task.id} 
                className="glass-effect p-6 rounded-xl hover:shadow-xl transition-all duration-200 transform hover:-translate-y-1 border border-gray-200"
                ...
                <div className="flex flex-col lg:flex-row lg:justify-between lg:items-start gap-4">
                  ...
                  <div className="flex lg:flex-col gap-2 items-stretch lg:items-end">
                    <select
                      ...
                      className="px-4 py-2 border border-gray-300 rounded-lg text-sm font-medium focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all bg-white"
                    >
      ...
      {showCreateModal && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4 z-50 animate-fade-in">
          <div className="bg-white rounded-2xl p-8 max-w-md w-full shadow-2xl animate-slide-up border border-gray-200">
            ...
            <form onSubmit={handleCreateTask}>
              <div className="space-y-5">
                <div>
                  ...
                  <input
                    type="text"
                    required
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg bg-white text-gray-900 placeholder:text-gray-400 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                ...
                <div>
                  ...
                  <textarea
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg bg-white text-gray-900 placeholder:text-gray-400 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 resize-none"
                    rows="4"
              ...
              <div className="flex gap-3 mt-8">
                <button
                  type="button"
                  onClick={() => setShowCreateModal(false)}
                  className="flex-1 px-6 py-3 border-2 border-gray-300 text-gray-700 rounded-lg bg-white hover:bg-gray-50 transition-all font-medium"
                >
                  Cancel
                </button>
                <button
